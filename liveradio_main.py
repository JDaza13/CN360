...
# ffmpeg -stream_loop -1 -re -i video/base_radio_file_muted.mp4 -re -f concat -i audio_input_list.txt -map 0:v -map 1:a -c:v libx264 -vf format=yuv420p -b:v 2M -bufsize 4M -maxrate 2M -g 50 -c:a aac -b:a 128k -flags +global_header -f flv rtmp://x.rtmp.youtube.com/live2/
